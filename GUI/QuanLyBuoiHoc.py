...
class UI_QuanLyBuoiHoc(object):
        ...
        def loadDataCmbGv(self):
                ...
                if list is not None:
                        for row in list:
                                self.cmbGv.addItem(row[1],row[0])
        ...
        def getDataRow(self):                
                ...
                self.cmbLop.setCurrentIndex(self.cmbLop.findData(self.tbwBuoiHoc.item(cr,4).text()))        
                self.cmbGv.setCurrentIndex(self.cmbGv.findData(self.tbwBuoiHoc.item(cr,5).text()))

        def validate(self, bh: BuoiHoc):        
                if bh._giobatdau=='00:00:00' or bh._gioketthuc == '00:00:00' or \
                bh._malop == '' or bh._magiangvien == '':
        ...
        def update(self):
                ...
                magiangvien = self.cmbGv.currentData()
