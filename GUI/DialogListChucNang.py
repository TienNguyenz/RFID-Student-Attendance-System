...
class Ui_Dialog(object):
    ...
    "}")
        ...
        def retranslateUi(self, Dialog):
            ...
            Dialog.setWindowTitle(_translate("Dialog", "Chọn chức năng"))
        ...
        def openDialogListChucNang(self, maquyen):
            ...
            for cn in list:
                ...
                # Sử dụng CSS để làm sáng checkbox
                ckb.setStyleSheet("""
                    QCheckBox {
                        color: white;
                        font-weight: bold;
                    ...
                    QCheckBox::indicator {
                        border: 2px solid #0099FF;  /* Màu viền sáng */
                        background-color: #E6F7FF;  /* Màu nền sáng */
                        width: 20px;
                        height: 20px;
                    }
                    QCheckBox::indicator:checked {
                        background-color: #66CCFF;  /* Màu sáng khi chọn */
                        border: 2px solid #33B5E5;  /* Màu viền sáng khi chọn */
                    }
                    QCheckBox::indicator:unchecked {
                        background-color: #FFFFFF;  /* Màu nền sáng khi chưa chọn */
                        border: 2px solid #CCCCCC;  /* Màu viền nhạt khi chưa chọn */
                    }
                    QCheckBox:hover {
                        background-color: rgba(255, 255, 255, 0.2);  /* Màu nền sáng khi di chuột qua */
                    }
                """)
