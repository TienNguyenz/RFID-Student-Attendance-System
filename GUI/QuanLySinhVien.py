...
class UI_QuanLySinhVien(object):
        ...
        def setupUi(self, MainWindow):
                ...
                icon = QtGui.QIcon()
                icon.addPixmap(QtGui.QPixmap("../image/icon/moon_symbol_50px.png"),
                ...
                icon1 = QtGui.QIcon()
                icon1.addPixmap(QtGui.QPixmap("../image/icon/time_50px.png"),
                                QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
                ...
                icon2 = QtGui.QIcon()
                icon2.addPixmap(QtGui.QPixmap("../image/icon/close_50px.png"),
                                QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
                ...
                icon3 = QtGui.QIcon()
                icon3.addPixmap(QtGui.QPixmap("../image/icon/subtract_50px.png"),
                                QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        def retranslateUi(self, MainWindow):
                ...
                self.btnLayAnhSV.setText(_translate("MainWindow", "Quét thẻ sinh viên"))
