...
class UI_Home():
        ...
        "}")
                ...
                self.btnDD = QtWidgets.QPushButton(parent=self.verticalFrame)
                self.btnDD.setMinimumSize(QtCore.QSize(0, 30))
                font = QtGui.QFont()
                font.setPointSize(12)
                font.setBold(True)
                font.setWeight(75)
                self.btnDD.setFont(font)
                self.btnDD.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
                self.btnDD.setStyleSheet("#btnDD\n"
                                         "{\n"
                                         "    font-weight:bold;\n"
                                         "padding-top:7px;\n"
                                         "padding-bottom:7px;\n"
                                         ...
                                         "}")
                icon5 = QtGui.QIcon()
                icon5.addPixmap(QtGui.QPixmap("../image/icon/home_40px.png"), QtGui.QIcon.Mode.Normal,
                                QtGui.QIcon.State.Off)
                self.btnDD.setIcon(icon5)
                self.btnDD.setIconSize(QtCore.QSize(20, 20))
                self.btnDD.setObjectName("btnDD")
                self.verticalLayout_2.addWidget(self.btnDD)
        ...
        "}")
                icon5 = QtGui.QIcon()
                icon5.addPixmap(QtGui.QPixmap("../image/icon/graph_report_script_50px.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        "background-color: black;\n"
        "color:white;\n"
        "icon: url(\"../image/icon/user_settings_white_40px.png\")\n"
        "}")
                icon6 = QtGui.QIcon()
                icon6.addPixmap(QtGui.QPixmap("../image/icon/user_settings_40px.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        "}")
                icon7 = QtGui.QIcon()
                icon7.addPixmap(QtGui.QPixmap("../image/icon/password_key_40px.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        "}")
                icon11 = QtGui.QIcon()
                icon11.addPixmap(QtGui.QPixmap("../image/icon/student_center_50px.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        "}")
                ...
                self.btnUpdateSV.clicked.connect(self.countSV)
        ...
        "")
                ...
                self.btnUpdateBH = QtWidgets.QPushButton(parent=self.frmHome2)
                self.btnUpdateBH.setGeometry(QtCore.QRect(10, 10, 71, 27))
                font = QtGui.QFont()
                font.setPointSize(10)
                font.setBold(True)
                font.setWeight(75)
                self.btnUpdateBH.setFont(font)
                self.btnUpdateBH.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
                self.btnUpdateBH.setStyleSheet("#btnUpdateBH\n"
        "{\n"
        " border-radius: 5px;\n"
        "background-color: white;\n"
        "font-weight:bold;\n"
        ...
        "color:white;\n"
        "}")
                self.btnUpdateBH.setObjectName("btnUpdateBH")
                self.btnUpdateBH.clicked.connect(self.countBuoiHoc)
        ...
        "}")
                icon12 = QtGui.QIcon()
                icon12.addPixmap(QtGui.QPixmap("../image/icon/school_50px.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        "")
                ...
                self.btnUpdateClass = QtWidgets.QPushButton(parent=self.frmHome3)
        ...
        "}")
                ...
                self.btnUpdateClass.clicked.connect(self.countLop)
        ...
        "}")
                icon13 = QtGui.QIcon()
                icon13.addPixmap(QtGui.QPixmap("../image/icon/google_classroom_50px.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
                self.pushButton_8.setIcon(icon13)
                self.pushButton_8.setIconSize(QtCore.QSize(26, 26))
                self.pushButton_8.setObjectName("pushButton_8")
                self.lblLop = QtWidgets.QLabel(parent=self.frmHome3)
                self.lblLop.setGeometry(QtCore.QRect(0, 90, 241, 31))
                font = QtGui.QFont()
                font.setPointSize(25)
                font.setBold(True)
                font.setWeight(75)
                self.lblLop.setFont(font)
                self.lblLop.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
                self.lblLop.setStyleSheet("")
                self.lblLop.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        "}")
                ...
                self.verticalLayoutWidget.setGeometry(QtCore.QRect(11, 9, 571, 451))
        ...
        "")
                icon14 = QtGui.QIcon()
                icon14.addPixmap(QtGui.QPixmap("../image/icon/Attendance_50px.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        "")
                icon15 = QtGui.QIcon()
                icon15.addPixmap(QtGui.QPixmap("../image/icon/teacher_50px.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        def retranslateUi(self, MainWindow):
                ...
                self.label_3.setText(_translate("MainWindow", "HỆ THỐNG ĐIỂM DANH BẰNG THẺ SINH VIÊN"))
                self.btnTrangChu.setText(_translate("MainWindow", "Trang chủ"))
                self.btnQuanLy.setText(_translate("MainWindow", "Quản lý"))
                self.btnNhanDien.setText(_translate("MainWindow", "Quét thẻ"))
                ...
                self.btnUpdateBH.setText(_translate("MainWindow", "Cập nhật"))
                ...
                self.pushButton_8.setText(_translate("MainWindow", "Số lớp quản lý"))
        ...
        def countSV(self):
                svBUS = SinhVienBUS()
                countsv = svBUS.countAll()
                self.lblSV.setText(str(countsv))     
        def countBuoiHoc(self):
                bhBUS = BuoiHocBUS()
                countbh = bhBUS.countAll()
                self.lblBuoiHoc.setText(str(countbh)) 
        def countLop(self):
                lBUS = LopBUS()
                countl = lBUS.countAll()
                self.lblLop.setText(str(countl))
